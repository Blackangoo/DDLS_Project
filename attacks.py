...
from FLAlgorithms.users.userperavg import AttackerGradientReversionperAvg
from FLAlgorithms.users.userpFedMe import AttackerGradientReversionpFedMe
...
def main(dataset, algorithm, model, batch_size, learning_rate, beta, lamda, num_glob_iters,
    ...
    malicious_clients_percentage = 0.2
    ...
    for i in range(times):
        ...
        if(algorithm == "pFedMe"):
            ...
            malicious_clients = random.sample(server.users, num_malicious_clients)
            for client in malicious_clients:
                client.__class__ = AttackerGradientReversionpFedMe
        ...
        if(algorithm == "PerAvg"):
            ...
            malicious_clients = random.sample(server.users, num_malicious_clients)
            for client in malicious_clients:
                client.__class__ = AttackerGradientReversionperAvg
